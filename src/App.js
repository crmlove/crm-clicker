  ...
  // Problems for different client types
	const problems = {
	  ...
	  business: [
		...
		{ problem: "Компания бизнесмена не может интегрировать с CRM", solution: "Разработать коннекторы для популярных CRM" },
		...
		{ problem: "ИТ отдел бизнеса требует SSO", solution: "Поддержать SAML 2.0 и OAuth 2.0 SSO" },
	  ...
	  tech: [
		...
		{ problem: "Технарю нужен ночной режим", solution: "Добавить переключение тёмной темы" },
	  ...
	  creative: [
		...
		{ problem: "Креативщик просит настроить коллаборации", solution: "Реализовать одновременное редактирование в реальном времени" },
